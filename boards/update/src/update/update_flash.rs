    ...
    Interface: FlashInterface,
{
    ...
    fn flash_trailer_write<Part: ValidPart + Swappable>(
        ...
        // defmt::println!("fn flash_trailer_write");
    ...
    Interface: FlashInterface,
{
    ...
    fn rustboot_update<'a>(&self, rollback: bool) -> Result<RustbootImage<'a, Boot, StateTesting>> {
        ...
        // defmt::println!("fn rustboot_update");
    ...
    Interface: FlashInterface,
{
    fn rustboot_start(self) -> ! {
        ...
        //defmt::println!("rustBoot Starts.");
        //info!("rustBoot Starts.");

        // defmt::println!("Opening Partitions.");
        ...
        match boot {
            ...
            ImageType::BootInSuccessState(img) => {
                ...
                .0;
                hal_preboot();
                // defmt::println!("BootInSuccessState");
                hal_boot_from(base_img_addr)
            }
            ...
            ImageType::BootInTestingState(img) => {
                ...
                .0;
                hal_preboot();
                // defmt::println!("BootInTestingState");
                hal_boot_from(base_img_addr)
            }
    ...
    fn update_trigger(self) -> Result<()> {
        ...
        // defmt::println!("fn update_trigger");
    ...
    fn update_success(self) -> Result<()> {
        ...
        // defmt::println!("fn update_success");
